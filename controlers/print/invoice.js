...
doc.font("public/font/Montserrat-Regular.ttf");
doc.text(`Email`, 25 + 10, 120, { width: 50, align: "left" })
doc.text(`Banca`, 25 + 10, 132, { width: 50, align: "left" })
doc.text(`Cont`, 25 + 10, 144, { width: 50, align: "left" })
...
if(invoice.supplier.name === 'NEW COLARA S.R.L.'){
  doc.image('public/icons/logo-tzero.jpeg', 250, 50, {width: 80})
}
...
if(productsCount > 30 && productsCount <= 60){
  firstChunk = 30
  restChunks = 54
}

// if(productsCount > 41 && productsCount <= 60){
//   firstChunk = 30
//   restChunks = 54
// }
