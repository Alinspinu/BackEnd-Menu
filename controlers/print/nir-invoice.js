...
ingChunks.forEach((ch, i) => {
    doc = addIngredients(doc, ch, rowHeigth, y, i+1, headerHeight, rectHeigth, rectStartH, pages, invoice.taxExclusiveAmount, invoice.taxInclusiveAmount, invoice.vatAmount, pageCount)
})
...
function addIngredients(doc, ch, rowHeigth, y, headerHeight, rectHeigth, rectStartH, page, pageLenght, taxExclusiveAmount, taxInclusiveAmount, vatAmount, pageCount){
     doc.fillColor('black') 
  if(page !== 1) {
      y = y - 180
