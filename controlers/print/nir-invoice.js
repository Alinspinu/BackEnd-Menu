...
doc.text(`Banca`, 25 + 15, 72 + 7, { width: 50, align: "left" })
doc.text(`Cont:`, 25 + 15, 90 + 7, { width: 50, align: "left" })
...
doc.text(`${invoice.supplier.iban}`, 55 + 15, 90 +7)
...
doc.text(`Banca`, 395 - 40, 72 + rh + 5, { width: 35, align: "left" })
doc.text(`Cont:`, 395 - 40, 90 + rh + 5, { width: 30, align: "left" })
...
doc.text(`${invoice.locatie.bank}`, 395, 72+rh + 5 , { width: 165, align: "left" });
doc.text(`${invoice.locatie.account}`, 395 , 90+rh + 5 , { width: 165, align: "left" });
