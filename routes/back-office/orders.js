...
router.route('/monitors')
        .post(orderRoutes.endPending)
        .put(orderRoutes.prepStatusDone)
        .get(orderRoutes.liftStatusDone)
...
router.route('/update-order').post(orderRoutes.updateOrder)


router.route('/get-time').get(orderRoutes.sendOrderTime);
router.route('/bill', authApi)
    .post(orderRoutes.saveOrEditBill)
    .put(orderRoutes.deleteOrders)
    .delete(orderRoutes.deleteOrder)
